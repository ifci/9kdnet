...
<!--content开始-->
    ...
    <div class="main_nav center pr">
        ...
        <div class="main_po pa">
        	...
        	<?php if($details == 1): ?>>
        	<a href="/9kd/Case/index.html" title=""><?php echo ($info['title']); ?></a><?php endif; ?>
        </div>
    </div>
</div>
        <!-- 案例 -->
        <div class="introduction bgf8 pb30">
            <div class="main_t center tac">
                <b><?php echo L('T_CASE');?></b>
            </div>
            <ul class="case center">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <div class="case_ty1 clearfix">
                        <a href="<?php echo U('case/read',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>">
                        <div class="case_ty2 fl wimg">
                            <img src="<?php echo get_default_img($vo['image_id']);?>" alt="" />
                        </div>
                        <div class="case_ty3 fl">
                            <div class="case_ty4 case_ty7">公司名称：<?php echo ($vo["title"]); ?></div>
                            <div class="case_ty7">
                    ...
                    <div class="case_ty6 clearfix">
                        <div class="w50 fl">
                            域名网址：<?php echo ($vo["url"]); ?>
                        </div>
                        <div class="w50 tar fl">
                            入驻时间：<?php echo (date('Y-m-d',$vo["published"])); ?>
                            <span class="dib vm"></span>
                            <a href="<?php echo U('case/read',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>" title="">查看详情>></a>
                        </div>
                    </div>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="tac"><?php echo ($page); ?></div>
                <!-- <div class="paging tac">
                 12 条记录 1/3 页  <a href='/case/index/p/2.html'>下一页</a>     &nbsp;<span class='current'>1</span>&nbsp;<a href='/case/index/p/2.html'>&nbsp;2&nbsp;</a>&nbsp;<a href='/case/index/p/3.html'>&nbsp;3&nbsp;</a>                   </div> -->
            </ul>
        </div>
    </div>
    <!--content结束-->
