...
<!--content开始-->
    ...
    <div class="main_nav center pr">
        ...
        <div class="main_po pa">
        	...
        	<?php if($details == 1): ?>>
        	<a href="/9kd/Introduce/index.html" title=""><?php echo ($info['title']); ?></a><?php endif; ?>
        </div>
    </div>
</div>
        ...
        <div class="introduction bgf8 pb30">
            <div class="main_t center tac">
                <b><?php echo L('T_INTRODUCE');?></b>
            </div>
            <div class="contact center">
                <div class="contact_ty9 contact_ty11">
                    <?php echo ($jkdjs[0]["content"]); ?>
                </div>
                <div class="contact_ty8">
                    <div class="introduction_list clearfix">
                        <i class="icon fl"></i>
                        <div class="introduction_ty2 fl">
                            <div class="introduction_ty3 mt20">
                                <b><?php echo ($jkdjs[1]["page_name"]); ?></b>
                            </div>
                        </div>
                    </div>
                    <div class="contact_ty9">
                    	<?php echo ($jkdjs[1]["content"]); ?>
                    </div>
                </div>
                <div class="contact_ty8">
                    <div class="introduction_list introduction_list2 clearfix">
                        ...
                        <div class="introduction_ty2 fl">
                            <div class="introduction_ty3 mt20">
                                <b><?php echo ($jkdjs[2]["page_name"]); ?></b>
                            </div>
                        </div>
                    </div>
                    <div class="contact_ty9">
                    	<?php echo ($jkdjs[2]["content"]); ?>
                    </div>
                </div>
                <div class="contact_ty8">
                    ...
                    <div class="contact_ty9">
                    <div class="contact_ty2 clearfix">
                    <div class="contact_ty3 fl">
                        <!-- 上下图片展示,最多3张图 -->
                        <div class="album clearfix">
                            <div class="album_l wimg fl">
                                <img src="/9kd/Public/Home/images/pic_30.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="contact_ty4 fl">
                        <div class="contact_ty5">
                            <b>张启明</b>
                        </div>
                        <div class="contact_ty6">
                        	<?php echo ($jkdjs[3]["content"]); ?>
                        </div>
                    </div>
                </div>
                <div class="clearfix">
                    <div class="contact_ty4 fl">
                        ...
                        <div class="contact_ty6">
                        	<?php echo ($jkdjs[4]["content"]); ?>
                        </div>
                    </div>
                    <div class="contact_ty7 fl">
                        <!-- 上下图片展示,最多3张图 -->
                        <div class="album clearfix">
                            <div class="album_l wimg fl">
                                <img src="/9kd/Public/Home/images/pic_29.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
