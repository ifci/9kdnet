 ...
 <!--content开始-->
    ...
    <div class="main_nav center pr">
        ...
        <div class="main_po pa">
        	...
        	<?php if($details == 1): ?>>
        	<a href="/9kd/Case/read/id/20.html" title=""><?php echo ($info['title']); ?></a><?php endif; ?>
        </div>
    </div>
</div>
        <!-- 案例 -->
        <div class="introduction" style="margin-top:20px;">
            <div class="casede center clearfix">
                <div class="categoryLeft">
                    <div class="fatherNav">
                        热门案例<a href="<?php echo U('/Case/');?>" title="点击查看更多案例">查看更多>></a>
                    </div>
                    <div class="leftNav">
                        <ul>
                            <?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <a href="<?php echo U('Case/read',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                    <div class="leftContact">
                        ...
                        <div class="tencent">
                            <ul>
                                <li>建站顾问：&nbsp;&nbsp;
                                    <a href="tencent://message/?uin=<?php echo ($site["qq"]); ?>" target="_blank">
...
<div style="float:left;width:730px;border:1px solid #c7c7c7;margin-bottom: 20px;">
                <div class="casede_t tac">
                    ...
                    <?php if($info['image_id'] != 0): ?><div style="text-align:center;margin-top:30px;"><img src="<?php echo get_default_img($info['image_id']);?>" alt="" border="0" /></div><?php endif; ?>
                <p class="bottom">
                ...
                <div class="casede_b clearfix">
                    <div class="casede_bl fl">
                        <a href="<?php echo $prev == null ? 'javascript:':U('Case/read',array('id'=>$prev[id]));?>" title="<?php echo ($prev["title"]); ?>">上一篇： <?php echo $prev[title] == null ?'没有了':$prev[title];?></a>

                    </div>
                    <div class="casede_br fr">
                        <a href="<?php echo $next == null ? 'javascript:':U('Case/read',array('id'=>$next[id]));?>" title="<?php echo ($next["title"]); ?>">下一篇： <?php echo $next[title] == null ?'没有了':$next[title];?></a>
                    </div>
                </div>
                <div class="weibo">
