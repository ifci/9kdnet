...
<head>
    ...
    <title>添加、编辑荣誉-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
    <?php $addCss=""; $addJs=""; $currentNav ='荣誉管理 > 荣誉管理'; ?>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                    ...
                    <tr>
                        ...
                        <td><select name="info[unique_id]" id="">
                            <option value="gsry" <?php echo $info['unique_id'] == 'gsry'?'selected':'';?>>公司荣誉</option>
                        </select></td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/9kd/jkd/Honor/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
        ...
        $("#checkPageUnique").click(function(){
            ...
            $.getJSON("/9kd/jkd/Honor/checkPageUnique", { title:$("#unique_id").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
