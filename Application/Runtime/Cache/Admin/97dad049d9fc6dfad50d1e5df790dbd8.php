...
<script type="text/javascript">
    $(function(){
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/9kd/jkd/Siteinfo/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
        ...
        $("#checkPageUnique").click(function(){
            ...
            $.getJSON("/9kd/jkd/Siteinfo/checkPageUnique", { title:$("#unique_id").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
