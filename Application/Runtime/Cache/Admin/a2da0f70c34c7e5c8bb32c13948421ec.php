...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='视频管理 > 添加编辑视频'; ?>
            ...
            $(function(){var  content ;
                KindEditor.ready(function(K) {
                    content = K.create('#content',{
                        ...
                        uploadJson:'/9kd/Public/kindeditor/php/upload_json.php?dirname=video'
                    });
                });
                $("#checkNewsTitle").click(function(){
                    $.getJSON("/9kd/jkd/Video/checkNewsTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
